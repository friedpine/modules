...
import os
def trim(seq,qua):
	seq = re.sub(r'(GTCGACGGCGCGCCGGATCCATA|ATATCTCGAGGGCGCGCCGGATCC|ATATGGATCCGGCGCGCCGTCGAC)',"A"*24,seq)
	try:
		capture = re.search(r'((ATATCTCG|AGGGCGCG|CCGGATCC|GTCGACGG|CGCGCCGG|GATCCATA)(.{0,30})A{10,100})',seq).group(1)
